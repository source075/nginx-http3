...
sed -i 's|--with-mail --with-mail_ssl_module --with-stream --with-stream_realip_module --with-stream_ssl_module --with-stream_ssl_preread_module|--with-http_v3_module --with-pcre-jit --without-http_empty_gif_module --without-http_upstream_zone_module|g' rules
cd ..
